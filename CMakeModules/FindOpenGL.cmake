...
IF (WIN32)
  IF (CYGWIN)
    ...
    FIND_PATH(OPENGL_INCLUDE_DIR gl.h
      PATH_SUFFIXES include/GL include/OpenGL include
    )
...
ELSE (WIN32)
  ...
  IF (APPLE)
    ...
    FIND_PATH(OPENGL_gl_INCLUDE_DIR gl.h
      PATH_SUFFIXES include/GL include/OpenGL include
      DOC "Include for gl.h on OSX")
    FIND_PATH(OPENGL_glu_INCLUDE_DIR glu.h
      PATH_SUFFIXES include/GL include/OpenGL include
      DOC "Include for glu.h on OSX")
    FIND_PATH(OPENGL_glext_INCLUDE_DIR glext.h
      PATH_SUFFIXES include/GL include/OpenGL include
      DOC "Include for glext.h on OSX")
    SET(OPENGL_INCLUDE_DIR
        "${OPENGL_gl_INCLUDE_DIR}"
        "${OPENGL_glu_INCLUDE_DIR}"
        "${OPENGL_glext_INCLUDE_DIR}")
  ...
  ELSE(APPLE)
    ...
    FIND_PATH(OPENGL_xmesa_INCLUDE_DIR xmesa.h
      PATH_SUFFIXES include/GL include/OpenGL include
      PATHS
      /usr/share/doc/NVIDIA_GLX-1.0/include
      /usr/openwin/share/include
