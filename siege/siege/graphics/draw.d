...
class DrawModule
{
    ...
    {
        curColor = Color(col.x, col.y, col.z, col.w);
    }
    void color(iVector col)
    {
        curColor = Color(col.x / 255.0, col.y / 255.0, col.z / 255.0, col.w / 255.0);
    }
    void color(float r, float g, float b, float a = 1.0)
    {
    ...
    {
        curColor = Color(r / 255.0, g / 255.0, b / 255.0, a / 255.0);
    }
    void color(float col, float a = 1.0)
    {
        curColor = Color(col, col, col, a);
    }
    void color(ubyte col, ubyte a = 255)
    {
        curColor = Color(col / 255.0, col / 255.0, col / 255.0, a / 255.0);
    }
